...
function sugar(client) {
  ...
  return {
    ...
    getMatrixForId: function(id) {
      return this.table("Matrix").read(id);
    },
    getPubmedsForIds: function(pmids) {
      
      var keys = pmids.split(",").map(function(pmid) {
        return { Pmid:pmid };
      });
      ...
      return client.batchGetItem(params);
    }
    ,
    ...
    // TODO Repeat batchGetItem until no UnprocessedKeys
