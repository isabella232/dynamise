  ...
  return {
    ...
    table: function table(tableName) {
      return {
        ...
        multiUpsert: function (client, tableName, items) {
          var params = {
            RequestItems: {}
          };
        ...
        upload: function (input) {
          ...
          var uploadStream = new UploadStream(client, tableName, table(tableName).multiUpsert);
        ...
        query: function (params) {
          ...
          var querySugar = {
            ...
            returnConsumedCapacity: function (value) {
              params.ReturnConsumedCapacity = value || "TOTAL";
              return querySugar;
            },
            filter: function (key) {
        ...
        "FileId": {
          ...
          "ComparisonOperator": "BETWEEN"
             ...
             * @param key
             * @returns {{beginsWith: Function, between: Function, equals: Function, gt: Function, lt: Function, lte: Function, gte: Function}}
             */
            where: function (key) {
              ...
              return {
                ...
                between: function (value) {
                  ...
                  params.KeyConditions[key] = params.KeyConditions[key] || {};

                  params.KeyConditions[key] = {
                    AttributeValueList: args.map(function (arg) {
                      return {S: arg.toString()};
                      //return transform.to(arg);
                    }),
                    ComparisonOperator: "BETWEEN"
                  };
            ...
            select: function (select) {
              ...
              if (Array.isArray(select)) {
                //TODO There is a newer parameter available. Use ProjectionExpression instead
                params.AttributesToGet = select;
                params.Select = "SPECIFIC_ATTRIBUTES";
                return querySugar;
              }

              params.Select = selectMapping[select] || "ALL_ATTRIBUTES";
            ...
            //from? startWith?, startingWith?,
            from: function (exclusiveStartKey) {
              params.ExclusiveStartKey = transform.to(exclusiveStartKey);
            },
            exec: function () {
        ...
        scan: function () {
          var scanSugar = {
            exec: function() {
              return promise.scan(client, tableName);
            }
          };
