...
function sugar(client) {
  ...
  return {
    ...
    /**
     * Does an multiUpsert on the tables specified in the
     * tables object. Should look like
     * { "TableA": [item1, item2], "TableB": [item1, item2] }
     *
     * Consider that you are only able to process 25 items at a time,
     * at the moment!
     *
     * @param {Object} tables
     * @returns {Promise}
