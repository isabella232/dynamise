...
function sugarClient(client) {
  ...
  return {
    ...
    /**
     * Recreates the tables if existing or creates the table if not and waits until active.
     *
     * @param {Array} tableNames
     * @returns {Promise}
     */
    multiRecreate: function (tableNames) {
    ...
    update: function(params) {
      return sugar.table.update(client, params);
    },

    dynamo: dynamoClient(client),

    Condition: client.endpoint.Condition,
    ...
    table: function table(tableName) {
      return {
        ...
        /**
         * Used to build a query with sugar syntax.
         *
         * @param {Object=} params
         * @returns {Find}
         */
